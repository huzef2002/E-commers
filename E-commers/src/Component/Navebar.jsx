...
function Navebar() {
  ...
  return (
    <nav className=' flex justify-between lg:flex-row flex-col py-3 mx-6 mb-10'>
      ...
      <div>
        <input onChange={(e) => dispatch(setSearch(e.target.value))} type='search' name='search' placeholder='Search' autoComplete='off' className='p-3 border-gray-400 text-sm rounded-lg w-full lg:w-[25vw]' />
      </div>
    </nav>
  );
}
